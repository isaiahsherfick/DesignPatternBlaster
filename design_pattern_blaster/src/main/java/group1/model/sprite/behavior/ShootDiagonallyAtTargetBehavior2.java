...
public class ShootDiagonallyAtTargetBehavior2 implements Behavior
{
	private Sprite blueprint, target;
	int offsetX, offsetY, projectileSpeed;
	
	public ShootDiagonallyAtTargetBehavior2(int offsetX, int offsetY, Sprite blueprint, int projectileSpeed, Sprite target)
	{
	...
	public void performBehavior(Sprite sprite) 
	{
        ...
        //Generate dx and dy
        double dx = (target.getX() - x+100);
        double dy = (target.getY() - y+100);
	...
	{
		return new ShootDiagonallyAtTargetBehavior2(offsetX, offsetY, blueprint.copy(), projectileSpeed, target);
	}
}
